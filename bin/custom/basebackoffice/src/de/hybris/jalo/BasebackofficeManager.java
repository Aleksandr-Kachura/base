...
import de.hybris.constants.BasebackofficeConstants;
 ...
 */
public class BasebackofficeManager extends GeneratedBasebackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BasebackofficeManager.class.getName());
	 ...
	 */
	public static BasebackofficeManager getInstance()
	{
		return (BasebackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(BasebackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BasebackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BasebackofficeManager called.");
		}
	}
