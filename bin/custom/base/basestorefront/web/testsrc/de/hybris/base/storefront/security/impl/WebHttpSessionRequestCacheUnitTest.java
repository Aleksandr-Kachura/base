...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/basestorefront/electronics/en",
						"https://electronics.local:9002/basestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/basestorefront/electronics/en",
						"https://electronics.local:9002/basestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/basestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/basestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/basestorefront/electronics/en",
						"https://electronics.local:9002/basestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/basestorefront",
						"https://electronics.local:9002/basestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/basestorefront",
						"https://electronics.local:9002/basestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/basestorefront/electronics/en",
						"https://electronics.local:9002/basestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
