 ...
 */
package de.hybris.base.cockpits.setup;
...
import de.hybris.base.cockpits.constants.BaseCockpitsConstants;
 ...
 */
@SystemSetup(extension = BaseCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(BaseCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(BaseCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						BaseCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/basecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
