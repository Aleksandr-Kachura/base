 ...
 */
package de.hybris.base.test.setup;
...
import de.hybris.base.test.constants.BaseTestConstants;
import de.hybris.base.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = BaseTestConstants.EXTENSIONNAME)
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			else
			{
				...
				importImpexFile(context, "/basetest/import/qa-test-users.impex");

				LOG.info("Creating Reviews...");
				importImpexFile(context, "/basetest/import/reviews.impex");
				...
				importImpexFile(context, "/basetest/import/cstickets.impex");

				LOG.info("Creating Test Quotes...");
				importImpexFile(context, "/basetest/import/csquotes.impex");
			}
		}
	}
}
