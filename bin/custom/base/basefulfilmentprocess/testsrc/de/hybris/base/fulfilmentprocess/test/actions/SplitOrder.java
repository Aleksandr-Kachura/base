 ...
 */
package de.hybris.base.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(BaseFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(BaseFulfilmentProcessConstants.PARENT_PROCESS);
